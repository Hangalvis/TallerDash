...
def load_data():
    ...
    # Intentar encontrar automáticamente una columna de fecha
...
def description_card():
    ...
    return html.Div(
        ...
        children=[
            #html.H5("Proyecto 1"),
            html.H3("Pronostico de producción energetica"),
            html.Div(
                id="intro",
                children="Esta herramienta contiene información sobre la demanda energetica total en Austria cada hora segun lo publicado en ENTSO-E Data Portal. Adicionalmente, permite realizar pronosticos hasta 5 dias en el futuro."
            ),
        ],
    )
